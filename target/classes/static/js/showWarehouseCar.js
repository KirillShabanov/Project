let findAllNotSaleNotNull = document.getElementById('floatingVINForSearchCheckedCar');
console.log(findAllNotSaleNotNull)
findAllNotSaleNotNull = findAllNotSaleNotNull.value;


if (findAllNotSaleNotNull === null) {
